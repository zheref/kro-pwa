      ...
      !state.isCalendarConfigured && (
        ...
        >
          <HStack>
            <Alert.Indicator />
            <Alert.Title>
              You can connect your Google Account to record your sessions in
              your calendar.
            </Alert.Title>
          </HStack>
    ...
    >
      ...
      >
        ...
        {enabledToConfirmIntention && (
          <Button h="43px" p={3} variant="solid" bg="blue.500" rounded="4xl">
            Confirm
          </Button>
        )}
      </Group>
