...
export default function DurationDial({
  ...
  const [lightNeutralBg, lightNeutralFg1, lightTicksBg, lightBlue600] =
    useToken('colors', ['gray.50', 'gray.900', 'gray.500', 'blue.600'])

  const [darkNeutralBg, darkNeutralFg1, darkTicksBg, darkBlue600] = useToken(
    'colors',
    ['gray.900', 'gray.50', 'gray.400', 'blue.400'],
  )

  const [progressBg] = useToken('colors', ['blue.500'])
  ...
  const calculateAngleAndDuration = (
    clientX: number,
    clientY: number,
  ): number => {
